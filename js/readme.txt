xT Readme
---------
Zkouším pøechod na Git. Je to takové divné...
...
v0.95 (2006.11.16)
- xT.Eval odebráno, pøidána pøímá podpora do xT.request (pøi volání bez obsluné události budou pøijatá data evalována)
  a monost vynutit evalovaní nastavením content-type na text|application/javascript|js|eval
...
xT.Lib
Obsahuje spoleèné metody pouívané dalšími objekty (childsByTag, firstChildByTag)
...
v0.95 (2006.11.07)
- doplnìn druhı parametr v metodì init - obsahuje volitelná uivatelská data, která se pak pøedávají pøes xT
- pouití funkce $
